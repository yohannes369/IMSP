...
//   const [counters, setCounters] = useState(["", "", ""]); // Three input fields
...
//     newItems[index].counted_qty = counted;
//     newItems[index].difference = newItems[index].available_qty - counted;
//     setItems(newItems);
//   };

//   const handleCounterChange = (idx, value) => {
...
//     setSaving(true);
//     try {
//       // Send each item separately with counters
//       for (const item of items) {
//         await axios.post("http://localhost:5000/api/reports", {
//           ...item,
//           counter_names: counters.join(",") // attach counters as comma-separated string
//         });
//       }
...
//               <td className="border px-4 py-2">{item.available_qty}</td>
...
//             <td className="border px-4 py-2">{totalAvailable}</td>
//             <td className="border px-4 py-2">{totalCounted}</td>
//             <td className="border px-4 py-2">{totalDifference}</td>
//           </tr>
